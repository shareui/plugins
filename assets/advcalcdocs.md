...
Установи плагин через каталог плагинов exteraGram. Если установлена версия НИЖЕ 1.3.0 — удали её перед установкой новой.
...
Install the plugin via the exteraGram plugin catalog. If the version installed is LOWER than 1.3.0, remove it before installing the new one.
